...
class NRSCameraMotionGenCS : public FGlobalShader
{
public:
	static const int ThreadgroupSizeX = 8;
	static const int ThreadgroupSizeY = 8;
	...
	DECLARE_GLOBAL_SHADER(NRSCameraMotionGenCS);
	SHADER_USE_PARAMETER_STRUCT(NRSCameraMotionGenCS, FGlobalShader);
